...
// ====================================================
const inputMessage = document.getElementById('texte-message');
...
/**
 * Affiche la taille du texte dans la zone adjacente au champ de saisie
 */
...
/**
 * Génère le texte dans la zone d'affichage avec les configurations choisies
 */
function GenererTexte() {
    AfficherValeurInput(); // Pour le débugage

    affichageTexte.innerHTML = inputMessage.value;              // Affiche le texte
